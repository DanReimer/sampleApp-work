...
describe User do
	...
	before { @user = User.new(name: "Example User", email: "user@example.com", password: "foobar" * 2, password_confirmation: "foobar" * 2) }
	...
	describe "when emails are already taken" do
		before do
